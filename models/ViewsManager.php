...
class ViewsManager
{
  ...
  function setFileName($fileName) {
    ...
    if($fileName == "login.php" || $fileName =="sighnup.php" || $fileName =="productos.php" ) {
      $this->generateBody();
  ...
  function generateBody(){
    echo '<body style="background: linear-gradient(#ef9a9a, #f44336, #b71c1c);
    width: 100vw;
    height: 100vh;">';
  ...
  function loadSignUp(){
    ...
    $this->setFileName("sighnup.php");
  }

  function loadProductos(){
    $this->head->setTitle("Productos existentes");
